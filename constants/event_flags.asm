	...
	const_def
; Most of these flags are legacy flags. They will be gradually removed.
...
; Johto story events
	...
	const EVENT_GOT_SS_TICKET_FROM_BISHOP
	...
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_BISHOPS_AIDE
	const EVENT_GOT_TOGEPI_EGG_FROM_BISHOPS_AIDE
	...
	const EVENT_TALKED_TO_FARMER_ABOUT_MOOMOO ; 040
	const EVENT_DUDE_TALKED_TO_YOU
	const EVENT_LEARNED_TO_CATCH_POKEMON
	const EVENT_BISHOP_CALLED_ABOUT_STOLEN_POKEMON
	...
	const EVENT_SHOWED_TOGEPI_TO_BISHOP
	const EVENT_GOT_EVERSTONE_FROM_BISHOP
...
; Guitarist
	const EVENT_BEAT_GUITARIST_JIMMYA
...
; Johto items: 0x640
	const EVENT_CYNDAQUIL_POKEBALL_IN_BISHOPS_LAB
	const EVENT_TOTODILE_POKEBALL_IN_BISHOPS_LAB
	const EVENT_CHIKORITA_POKEBALL_IN_BISHOPS_LAB
...
; Johto people
	const EVENT_RIVAL_BOUNTIFUL_TOWN
	...
	const EVENT_BISHOPS_AIDE_IN_VIOLET_POKEMON_CENTER
	const EVENT_BISHOPS_AIDE_IN_LAB
	const EVENT_COP_IN_BISHOPS_LAB
...
; Non-legacy flags start
; Story events
	const EVENT_GOT_A_POKEMON_FROM_BISHOP
	const EVENT_GOT_CYNDAQUIL_FROM_BISHOP
	const EVENT_GOT_TOTODILE_FROM_BISHOP
	const EVENT_GOT_CHIKORITA_FROM_BISHOP
	const EVENT_GOT_PAPERS_FROM_WARD_CLERK
	const EVENT_FINISHED_BISHOPS_ERRAND
	const EVENT_TALKED_TO_MOM_BEFORE_JOURNEY
; Items
	const EVENT_ROUTE_101_POTION
	const EVENT_PLEASANT_GROVE_POTION1
	const EVENT_PLEASANT_GROVE_POTION2
	const EVENT_PLEASANT_GROVE_ANTIDOTE
	const EVENT_PLEASANT_GROVE_POKEBALL
	const EVENT_PLEASANT_GROVE_HIDDEN_GREAT_BALL
	const EVENT_PLEASANT_GROVE_HIDDEN_FULL_HEAL
	const EVENT_PLEASANT_GROVE_HIDDEN_SUPER_POTION
	const EVENT_PLEASANT_GROVE_HIDDEN_ETHER
	const EVENT_PLEASANT_GROVE_HIDDEN_REPEL
