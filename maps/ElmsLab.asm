...
BattleTestScript:
	...
	waitbutton
	closetext
	winlosstext ElmsLabWindowText2, ElmsLabWindowText2
...
.ObjectEvents: db 7
	person_event SPRITE_BISHOP, 2, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, ProfElmScript, -1
