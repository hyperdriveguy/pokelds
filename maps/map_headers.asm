...
;	map_header ElmsLab, TILESET_LAB, INDOOR, BOUNTIFUL_TOWN, MUSIC_PROF_ELM, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header ElmsLab, TILESET_LAB, INDOOR, BOUNTIFUL_TOWN, MUSIC_BOOK_OF_MORMON_STORIES, 0, PALETTE_DAY, FISHGROUP_SHORE
	...
	map_header ElmsHouse, TILESET_KRISS_HOUSE, INDOOR, BOUNTIFUL_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
