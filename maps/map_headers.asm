...
MapGroup24:
	...
	map_header BountifulTown, TILESET_JOHTO_1, TOWN, BOUNTIFUL_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_AUTO, FISHGROUP_OCEAN
;	map_header BishopsLab, TILESET_LAB, INDOOR, BOUNTIFUL_TOWN, MUSIC_Bishop, 0, PALETTE_DAY, FISHGROUP_SHORE
	...
	map_header KrissHouse1F, TILESET_KRISS_HOUSE, INDOOR, BOUNTIFUL_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissHouse2F, TILESET_KRISS_HOUSE_2F, INDOOR, BOUNTIFUL_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissNeighborsHouse, TILESET_HOUSE_1, INDOOR, BOUNTIFUL_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header BishopsHouse, TILESET_KRISS_HOUSE, INDOOR, BOUNTIFUL_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
