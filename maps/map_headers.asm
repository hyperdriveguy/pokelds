...
MapGroup16:
	...
	map_header HallOfFame, TILESET_ICE_PATH, INDOOR, INDIGO_PLATEAU, MUSIC_BOUNTIFUL_TOWN, 1, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup24:
	...
	map_header Route101, TILESET_JOHTO_1, ROUTE, ROUTE_101, MUSIC_ROUTE_101, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header BountifulTown, TILESET_JOHTO_1, TOWN, BOUNTIFUL_TOWN, MUSIC_LOVE_AT_HOME, 0, PALETTE_AUTO, FISHGROUP_OCEAN
;	map_header BishopsLab, TILESET_LAB, INDOOR, BOUNTIFUL_TOWN, MUSIC_Bishop, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header BishopsLab, TILESET_LAB, INDOOR, BOUNTIFUL_TOWN, MUSIC_BOOK_OF_MORMON_STORIES, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissHouse1F, TILESET_KRISS_HOUSE, INDOOR, BOUNTIFUL_TOWN, MUSIC_LOVE_AT_HOME, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissHouse2F, TILESET_KRISS_HOUSE_2F, INDOOR, BOUNTIFUL_TOWN, MUSIC_LOVE_AT_HOME, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissNeighborsHouse, TILESET_HOUSE_1, INDOOR, BOUNTIFUL_TOWN, MUSIC_LOVE_AT_HOME, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header BishopsHouse, TILESET_KRISS_HOUSE, INDOOR, BOUNTIFUL_TOWN, MUSIC_LOVE_AT_HOME, 0, PALETTE_DAY, FISHGROUP_SHORE
	...
	map_header Route101PleasantGate, TILESET_GATE, GATE, ROUTE_101, MUSIC_ROUTE_101, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup26:
	...
	map_header PleasantGrove, TILESET_ILEX_FOREST, CAVE, PLEASANT_GROVE, MUSIC_UNION_CAVE, 0, PALETTE_NITE, FISHGROUP_POND
	map_header CherrygroveMart, TILESET_MART, INDOOR, SPECIAL_MAP, MUSIC_NONE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header CherrygrovePokeCenter1F, TILESET_POKECENTER, INDOOR, SPECIAL_MAP, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header CherrygroveGymSpeechHouse, TILESET_HOUSE_1, INDOOR, SPECIAL_MAP, MUSIC_NONE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header GuideGentsHouse, TILESET_HOUSE_1, INDOOR, SPECIAL_MAP, MUSIC_NONE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header CherrygroveEvolutionSpeechHouse, TILESET_HOUSE_1, INDOOR, SPECIAL_MAP, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route30BerrySpeechHouse, TILESET_HOUSE_1, INDOOR, ROUTE_30, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header ClerksHouse, TILESET_POWER_PLANT, INDOOR, ROUTE_101, MUSIC_LOVE_AT_HOME, 0, PALETTE_DAY, FISHGROUP_SHORE
